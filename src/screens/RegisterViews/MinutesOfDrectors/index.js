...
const MinutesOfDirectors = ({ route, navigation }) => {
  ...
  const getRecordDetails = () => {
    var theRecord =mDirectors.find(x => x.id == entryId);
    setRecord(theRecord);
      ...
      {loading ?
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ padding: 4 }}>
          <View style={{ padding: 4 }}>
            {!entryId ?
              <Text style={[styles.cardTitleEdit, { paddingTop: 20, textDecorationLine: 'underline' }]}>Inex Of Minutes Of Directors</Text>
              :
              <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                <Text style={[styles.cardTitleEdit, { textDecorationLine: 'underline', paddingTop: 20, }]}>Inex Of Minutes Of Directors</Text>
                {editMode ? null :
          ...
          <View style={[{ paddingTop: 15 }]}>
            <Text style={editMode ? styles.cardTitleEdit : styles.cardTitle}>Date 0f Board meeting</Text>
            <TextInput
              value={director}
          ...
          <View style={[{ paddingTop: 15 }]}>
            <Text style={editMode ? styles.cardTitleEdit : styles.cardTitle}>state whethermeeting was </Text>
            <TextInput
          ...
          <View style={[{ paddingTop: 15 }]}>
            <Text style={editMode ? styles.cardTitleEdit : styles.cardTitle}>Date Which Resoltion Extracted </Text>
            <TextInput style={editMode ? styles.textInputEdit : styles.textInput}
              editable={editMode} onFocus={showDateOfEntryPicker} onKeyPress={showDateOfEntryPicker} label="Date of Entry" placeholder="mm/dd/yyy"
          ...
          <Text style={[editMode ? styles.cardTitleEdit : styles.cardTitle, { paddingTop: 15 }]}>Summary Of key Resolutions</Text>

          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <View style={[{ flex: 1 }]}>
              <Text style={editMode ? styles.cardTitleEdit : styles.cardTitle}>Location of the Orgin Issue</Text>
              <TextInput
...
export default  MinutesOfDirectors ;
const pickerStyle = {
	inputIOS: {
		color: '#333',
		paddingTop: 10,
